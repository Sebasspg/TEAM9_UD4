...
class EjercicioIniciante extends StatefulWidget {
  const EjercicioIniciante({super.key});

  @override
  State<EjercicioIniciante> createState() => _EjercicioInicianteState();
}

class _EjercicioInicianteState extends State<EjercicioIniciante> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Ejercicio Iniciante"),
        elevation: 0,
        centerTitle: true,
      ),
